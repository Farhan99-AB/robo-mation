...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_LOG_LEVEL_OFF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_LOG_LEVEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_LOG_THREAD_STACK_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0xf000);
